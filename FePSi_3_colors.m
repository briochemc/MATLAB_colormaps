function cmap = FePSi_3_colors
% 3-color palette for Aeolian, Sedimentary, and Hydrothermal
% from FePSi paper [Pasquier and Holzer, BGS, 2017]
A_hex = 'EE3333' ; % red
S_hex = 'CCCC55' ; % yellow
H_hex = '3366AA' ; % blue
...
%% Aux function to convert hex to RGB
